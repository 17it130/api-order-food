                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group row" style="padding: 0px 15px">
                                ...
                                <div class="col-lg-9">
                                    <p>{{ isset($customer->name) ? $customer->name : '' }}</p>
                                </div>
                            </div>
                            <div class="form-group row" style="padding: 0px 15px">
                                <label  class="col-lg-3">Số điện thoại:</label>
                                <div class="col-lg-9">
                                    <p>{{ isset($customer->phone) ? $customer->phone : '' }}</p>
                                </div>
                            </div>
                            <div class="form-group row" style="padding: 0px 15px">
                                <label  class="col-lg-3">Email:</label>
                                <div class="col-lg-9">
                                    <p>{{ isset($customer->email) ? $customer->email : '' }}</p>
                                </div>
                            </div>
                            <div class="form-group row" style="padding: 0px 15px">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-3 col-xs-6 text-center"
                                                            style="{{ $order[0]->status == 0 ? 'border: 1px solid; border-radius: 5px' : '' }}">
                                                            <div class="col-12">
                                                                <i class="mdi mdi-clock" style="font-size: 45px; color: red"></i>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="0" name="status" class="custom-control-input"
                                                                    value="0" {{ $order[0]->status == 0 ? 'checked' : ''}}>
                                                                <label class="custom-control-label" for="0">Đang chờ xác nhận</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 text-center"
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label" for="1">Đã xác nhân</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 text-center"
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label" for="2">Đang giao hàng</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 text-center"
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="3" name="status" class="custom-control-input"
                                                                    value="3" {{ $order[0]->status == 3 ? 'checked' : ''}}>
                                                                <label class="custom-control-label" for="3">Đã giao hàng</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
